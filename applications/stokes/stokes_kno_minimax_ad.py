...
def main():
    ...
    parser.add_argument("--op-steps", type=int, default=20)
    ...
    parser.add_argument("--fgsm-epsilon", type=float, default=0.01)
    parser.add_argument("--fgsm-heldout-count", type=int, default=20)
    parser.add_argument("--fgsm-eval-every", type=int, default=50)
    parser.add_argument("--lr-gen", type=float, default=5e-3)
